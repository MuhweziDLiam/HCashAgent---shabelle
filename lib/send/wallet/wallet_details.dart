...
class WalletRecipientPage extends BasePage {
  ...
  @override
  _WalletRecipientPageState createState() => _WalletRecipientPageState();
}

class _WalletRecipientPageState extends BaseState<WalletRecipientPage>
    with BasicPage {
  String? senderPhone,
      recipientPhone,
      paymentNetwork,
                          ...
                          fieldViewBuilder: (context, textEditingController,
                            ...
                            return Focus(
                              ...
                              child: TextInputField(
                                labelText: 'Enter HCash wallet number',
                                focusNode: focusNode,
                                ...
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Please enter the HCash wallet Number';
                                  }
  ...
  _processTransaction(
    ...
    if (accountNumber!.startsWith('+256')) {
      accountNumber = accountNumber!.replaceAll('+256', '0');
    }
    if (accountNumber!.startsWith('256')) {
      accountNumber = accountNumber!.replaceFirst('256', '0');
    }
    ...
    final Map data = {
      ...
      'narration': 'HCash Cash in payment Transaction',
    };
    print(data);
