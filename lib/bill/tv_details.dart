...
class TvRecipientPage extends BasePage {
  String? billerCode, billerName, billerLogo, packageName;
  String billerAmount;
  TvRecipientPage(
      {this.billerCode,
      this.billerName,
      ...
      this.billerAmount = '0'});
  @override
  _TvRecipientPageState createState() => _TvRecipientPageState();
}

class _TvRecipientPageState extends BaseState<TvRecipientPage> with BasicPage {
  String? senderPhone,
      recipientPhone,
      paymentNetwork,
      reference,
  ...
  void initState() {
    super.initState();
    _amountController.value = TextEditingValue(text: widget.billerAmount);
    getInfo();
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Flexible(
                                    child: MediumText(
                                      '${widget.billerName!} - ${widget.packageName!}',
            ...
            case 'FAILED':
              ...
              Get.to(
                () => TransactionStatusPage(
                  ...
                  templateId: 3,
                  body:
                      'Failed to Process ${widget.billerName} - ${widget.packageName} Payment.',
                  showStatement: false,
  ...
  _updateBalance(
    ...
    Get.off(
      () => TransactionStatusPage(
        body:
            'You have successfully paid ${widget.billerName!} - ${widget.packageName} for Decoder account holder',
        templateId: 5,
        showStatement: false,
