...
class WaterRecipientPage extends BasePage {
  String? billerCode, billerName, billerLogo;
  List<Bills>? waterLocations;
  WaterRecipientPage(
      {this.billerCode, this.billerName, this.billerLogo, this.waterLocations});
  @override
  _WaterRecipientPageState createState() => _WaterRecipientPageState();
}

class _WaterRecipientPageState extends BaseState<WaterRecipientPage>
    with BasicPage {
  String? senderPhone,
      recipientPhone,
      paymentNetwork,
  ...
  void initState() {
    super.initState();
    customerCode = widget.waterLocations!.first.billerCategory!;
    getInfo();
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            DropDownTextInputField(
                              ...
                              items: [
                                ...List.generate(
                                  widget.waterLocations!.length,
                                  (index) => DropDownItem(
                                    imgUrl:
                                        'assets/images/${widget.billerLogo!}',
                                    title: widget.waterLocations!
                                        .elementAt(index)
                                        .billerName,
                                    value: widget.waterLocations!
                                        .elementAt(index)
                                        .billerCategory,
                                  ),
                                )
