...
class BBBPaymentPage extends BasePage {
  String? providerType,
  ...
  BBBPaymentPage({
    this.providerType,
    this.providerNarration,
    this.providerOtherPaymentType,
    this.providerName,
    this.providerLogo,
  });
  @override
  _BBBPaymentPageState createState() => _BBBPaymentPageState();
}

class _BBBPaymentPageState extends BaseState<BBBPaymentPage> with BasicPage {
  String? senderPhone,
      recipientPhone,
      paymentNetwork,
      reference,
                    ...
                    Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            VSpace.md,
                            TextInputField(
                              labelText: 'Enter Number plate/Proposal number',
                              prefixIcon: Icon(
  ...
  validateMeterNumber() async {
    ...
    validateBodaBanjaAccount(_formSchoolKey.currentContext!, data)
        .then((value) async {
      if (value.status!) {
        progress.dismiss();
        setState(() {
        ...
        final double total = int.parse(convertedAmount).toDouble() +
  ...
  _processTransaction(
    ...
    switch (widget.providerType) {
      case 'Weekly Payments':
        service = 'BODABANJA_REPAYMENT';
        break;
      case 'Tax':
        service = 'BODABANJA_TAX';
        break;
      case 'Other Payments':
        switch (widget.providerOtherPaymentType) {
          case 'Repossession Charges':
            service = 'BODABANJA_REPOSSESSION';
            break;
          case 'Penalty':
            service = 'BODABANJA_PENALTY';
            break;
          case 'Tin':
            service = 'BODABANJA_TIN';
            break;
          case 'others':
            service = 'BODABANJA_OTHERCASE';
            break;
        }
        break;
      case 'Down Payment':
        service = 'BODABANJA_DOWNPAYMENT';
        break;
    }
    ...
    final Map data = {
      ...
      'proposalNumber': _accountNumberController.text,
      'paymentType': widget.providerType == 'Other Payments'
          ? widget.providerOtherPaymentType
          : widget.providerType,
      ...
      'narration': 'Tv payment Transaction',
    };
  ...
  _updateBalance(
    ...
    Get.off(
      () => TransactionStatusPage(
        body: 'You have successfully paid ${widget.providerName!} for ',
        templateId: 5,
        showStatement: false,
